...
pygame.init()#intialsing pygame
cell_size=30
cell_number=20
screen = pygame.display.set_mode((cell_number*cell_size,cell_number*cell_size))#screen is created
clock = pygame.time.Clock()#help to enhance time in pygame
...
while(True):
    ...
    #surfaces and  rectangles for drawing in pygame
    #surface-a layer tht can display graphics, ther is only multiple,not default displyed
    # create the syrface and display the surface
